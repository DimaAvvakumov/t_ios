...
//#define ServerParams_Host @"proteplo-dev.east-media.ru"
//#define ServerParams_URLString @"http://proteplo-dev.east-media.ru/"
//#define ServerParams_BaseURL [NSURL URLWithString: @"http://proteplo-dev.east-media.ru/"]

#define ServerParams_Host @"proteplo.east-media.ru"
#define ServerParams_URLString @"http://proteplo.east-media.ru/"
#define ServerParams_BaseURL [NSURL URLWithString: @"http://proteplo.east-media.ru/"]
